SELECT sales.orders.order_id, sales.orders.customer_id, sales.orders.order_status, sales.orders.order_date, sales.orders.required_date, sales.orders.shipped_date, sales.orders.store_id, sales.orders.staff_id, 
